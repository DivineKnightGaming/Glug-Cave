...
class GamepadIDs
{
	...
	#if linux
	public static inline var DPAD_LEFT = #if (OUYA) OUYAButtonID.DPAD_LEFT #elseif (windows) XboxButtonID.DPAD_LEFT #else OUYAButtonID.DPAD_LEFT #end ;
	public static inline var DPAD_RIGHT = #if (OUYA) OUYAButtonID.DPAD_RIGHT #elseif (windows) XboxButtonID.DPAD_RIGHT #else OUYAButtonID.DPAD_RIGHT #end;
	public static inline var DPAD_UP = #if (OUYA) OUYAButtonID.DPAD_UP #elseif (windows) XboxButtonID.DPAD_UP #else OUYAButtonID.DPAD_UP #end;
	public static inline var DPAD_DOWN = #if (OUYA) OUYAButtonID.DPAD_DOWN #elseif (windows) XboxButtonID.DPAD_DOWN #else OUYAButtonID.DPAD_DOWN #end;
	#end
}
